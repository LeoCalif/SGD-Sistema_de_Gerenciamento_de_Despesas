# 🚀 Roadmap & Ideias — Klif Despesas

Este arquivo serve como um painel de ideias, melhorias futuras e pendências (backlog) para o **Klif Despesas**. À medida que novas ideias surgirem, você pode listá-las aqui para planejar o desenvolvimento.
...
### 🏷️ 2. Categorias de Despesas
- Permitir categorizar cada lançamento (Ex: Alimentação, Lazer, Saúde, Transporte, Assinaturas).
- Exibir relatórios somando gastos de cada categoria.

### 🔔 4. Notificações / Alertas
- Enviar notificações em tempo real (ex: via Telegram, WhatsApp ou E-mail) quando um amigo vincular um gasto à sua conta ou quando uma caixinha atingir a meta.

### ☀️ 5. Alternador de Tema (Dark / Light Mode)
- Criar um botão rápido para alternar entre o tema escuro (atual) e um tema claro premium.
...
- Marque com `[ ]` as tarefas pendentes.
- Mude para `[/]` as tarefas que você estiver desenvolvendo no momento.
- Marque com `[x]` as tarefas concluídas.

*Exemplo:*
- [x] Ajustar visual do dashboard e glassmorphism
- [/] Mapear ideias no roadmap
